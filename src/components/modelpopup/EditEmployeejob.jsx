...
export const EditEmployeejob = ({ activeModal ,companys, selectedUser, users, address, jobs, setPreview, preview, getEmployeeData, employedata }) => {
  ...
  useEffect(() => {
    ...
    if (cc) {
      ...
      setValue("Labor_card_expiry", cc.end_date);
