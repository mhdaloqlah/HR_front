      ...
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <nav aria-label="Page navigation">
                <ul className="pagination mb-0" style={{position:"absolute", left:"0"}}>
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body d-flex flex-wrap justify-content-between gap-2">
              <nav aria-label="...">
                <ul style={{position:"absolute"}} className="pagination pagination-sm mb-0">
              ...
              <nav aria-label="...">
                <ul style={{position:"absolute"}} className="pagination mb-0">
                  <li className="page-item active" aria-current="page">
                    <span className="page-link">1</span>
                  </li>
                  <li className="page-item">
              ...
              <nav aria-label="...">
                <ul style={{position:"absolute"}} className="pagination pagination-lg mb-0">
                  <li className="page-item active" aria-current="page">
                    <span className="page-link">1</span>
                  </li>
                  <li className="page-item">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              <nav aria-label="Page navigation">
                <ul style={{position:"absolute"}} className="pagination justify-content-center mb-3">
                  <li className="page-item disabled">
              ...
              <nav aria-label="Page navigation">
                <ul style={{position:"absolute"}} className="pagination justify-content-end mb-0">
                  <li className="page-item disabled">
                    <Link className="page-link">Previous</Link>
                  </li>
                  <li className="page-item">
          ...
          <div className="card">
            ...
            <div className="card-body d-flex flex-wrap">
              <nav aria-label="..." className="me-3">
                <ul style={{position:"absolute"}} className="pagination  mb-3">
                  <li className="page-item disabled">
                    <Link className="page-link">Previous</Link>
                  </li>
                  <li className="page-item">
              ...
              <nav aria-label="...">
                <ul style={{position:"absolute"}} className="pagination">
                  <li className="page-item disabled">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <nav aria-label="Page navigation" className="pagination-style-2">
                <ul style={{position:"absolute"}} className="pagination mb-0 flex-wrap">
                  <li className="page-item disabled">
                    <Link className="page-link" to="#">
                      Prev
                    </Link>
