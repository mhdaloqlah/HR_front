...
import Addresses from "../../views/pages/Employees/Addresses.jsx";
import AllEmployee from "../../views/pages/Employees/AllEmpoyee";
import DisEmployee from "../../views/pages/Employees/DisEmployee.jsx";
import Attendance from "../../views/pages/Employees/Attendance.jsx";
import Empattendance from "../../views/pages/Employees/Empattendance.jsx";
import AllemployeeAttend from "../../views/pages/Employees/AllemployeeAttend.jsx";
import Agreement from "../../views/pages/Employees/Agreement.jsx";
  ...
  const routingObjects = [
    ...
    },
   {
    ...
    },
    {
      ...
      id: 134,
      path:"empattendance/:id",
      element: <Empattendance />
    },{
      id: 135,
      path:"AllemployeeAttend",
      element: <AllemployeeAttend/>
    }
    ,{
      id: 136,
      path:"agreement",
